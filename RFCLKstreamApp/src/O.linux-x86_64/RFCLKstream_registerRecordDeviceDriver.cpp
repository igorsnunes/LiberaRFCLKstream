...
/* Generated from ../O.Common/RFCLKstream.dbd */
...
static const char * const deviceSupportNames[93] = {
    "devAaiSoft",
    "devAaoSoft",
    "devAiSoft",
    "devAiSoftRaw",
...
static const dset * const devsl[93] = {
...
int RFCLKstream_registerRecordDeviceDriver(DBBASE *pbase)
{
    const char *bldTop = "/home/igor/LiberaRFCLKstream";
    ...
    registerDevices(pbase, 93, deviceSupportNames, devsl);
...
static const iocshFuncDef registerRecordDeviceDriverFuncDef =
                {"RFCLKstream_registerRecordDeviceDriver",1,registerRecordDeviceDriverArgs};
static void registerRecordDeviceDriverCallFunc(const iocshArgBuf *)
{
    RFCLKstream_registerRecordDeviceDriver(*iocshPpdbbase);
}
